...
function Logo({ size = 48 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Stories and Reviews logo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "linearGradient",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "#00fff7" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "#39ff14" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("clipPath", { id: "circle-clip", children: /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "50", cy: "50", r: "48" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "50", cy: "50", r: "48", fill: "url(#logoGrad)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "50", cy: "50", r: "48", fill: "#111", fillOpacity: "0.7" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { clipPath: "url(#circle-clip)", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "50", y1: "55", x2: "50", y2: "75", stroke: "#111", strokeWidth: "1.5" }),
          [48, 51, 54, 57, 60, 63, 66].map((y, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "line",
            {
              x1: i % 2 === 0 ? 23 : 25,
              y1: y,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "35,78 31,85 40,77", fill: "url(#logoGrad)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "rect",
            {
              x: "62",
...
function App() {
  ...
  const [privateMessages, setPrivateMessages] = reactExports.useState(
    () => load("sar_pm", [])
  );
  const [series, setSeries] = reactExports.useState(() => load("sar_series", []));
  ...
  const [siteOpen, setSiteOpen] = reactExports.useState(
    () => load("sar_siteopen", false)
  );
  const [authorBio, setAuthorBio] = reactExports.useState(() => load("sar_bio", ""));
  const [page, setPage] = reactExports.useState("home");
  const [browseMode, setBrowseMode] = reactExports.useState(false);
  const [adminPasswordVerified, setAdminPasswordVerified] = reactExports.useState(false);
  const [adminPasswordInput, setAdminPasswordInput] = reactExports.useState("");
  const [adminPasswordError, setAdminPasswordError] = reactExports.useState(false);
  const [selectedStoryId, setSelectedStoryId] = reactExports.useState(null);
  const [selectedProfilePrincipal, setSelectedProfilePrincipal] = reactExports.useState(null);
  const [category, setCategory] = reactExports.useState("recent");
  ...
  const isBanned = !!principal && bannedUsers.some((b) => b.principal === principal);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    ...
    const results = stories.filter(
      (s) => s.published && (s.title.toLowerCase().includes(q) || s.excerpt.toLowerCase().includes(q))
    );
  ...
  function getOrCreateProfile(p) {
    return userProfiles.find((u) => u.principal === p) ?? {
      principal: p,
  ...
  function updateProfile(updated) {
    setUserProfiles((prev) => {
      ...
      if (existing)
        return prev.map(
          (u) => u.principal === updated.principal ? updated : u
        );
      return [...prev, updated];
    });
  }
  ...
  function toggleFavorite(storyId) {
    ...
    const favs = profile.favorites.includes(storyId) ? profile.favorites.filter((f) => f !== storyId) : [...profile.favorites, storyId];
    updateProfile({ ...profile, favorites: favs });
  }
  function recordRead(storyId) {
    if (!principal) return;
    const profile = getOrCreateProfile(principal);
    const existing = profile.readHistory.find((r) => r.storyId === storyId);
    const entry = {
      storyId,
      progress: (existing == null ? void 0 : existing.progress) ?? 0,
      lastRead: Date.now()
    };
    const history = existing ? profile.readHistory.map((r) => r.storyId === storyId ? entry : r) : [...profile.readHistory, entry];
    updateProfile({ ...profile, readHistory: history });
    setStories(
      (prev) => prev.map(
        (s) => s.id === storyId ? { ...s, readCount: s.readCount + 1 } : s
      )
    );
  }
  function banUser(p) {
  ...
  function unbanUser(p) {
    setBannedUsers((prev) => prev.filter((b) => b.principal !== p));
  }
  if (!siteOpen && !isAdmin && !browseMode) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center text-white", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { size: 80 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h1",
        {
          ...
          children: "Stories and Reviews"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mt-2 mb-6", children: "Welcome! Browse stories or log in as admin." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 w-52", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
  ...
  function Nav() {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "bg-[#111] border-b border-[#222] sticky top-0 z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 py-3 flex items-center gap-4 flex-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", ref: searchRef, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            value: search,
        ...
        showSearch && searchResults.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-full left-0 mt-1 w-72 bg-[#1a1a1a] border border-[#333] rounded-lg shadow-lg z-50", children: searchResults.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => {
  ...
  if (page === "about")
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AboutPage, { authorBio })
    ] });
  if (page === "series")
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Nav, {}),
        ...
        StoryPage,
        {
          ...
          onComment: (text) => {
            ...
            const c = {
              ...
              storyId: story.id,
              author: (myProfile == null ? void 0 : myProfile.displayName) ?? `${principal.slice(0, 8)}...`,
              principal,
              text,
              createdAt: Date.now(),
              approved: true
          ...
          isFavorite: !!(myProfile == null ? void 0 : myProfile.favorites.includes(story.id)),
    ...
    if (!adminPasswordVerified) {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-6 p-10 rounded-2xl border border-white/10 bg-white/5 backdrop-blur shadow-2xl w-full max-w-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: "🔒" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white text-2xl font-bold tracking-wide", children: "Admin Access" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/50 text-sm text-center", children: "Enter the admin password to continue" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
            ...
            adminPasswordError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { "data-ocid": "admin.error_state", className: "text-red-400 text-sm", children: "Incorrect password. Please try again." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
  ...
  if (category === "recent") filtered.sort((a, b) => b.createdAt - a.createdAt);
    ...
    filtered.sort(
      (a, b) => comments.filter((c) => c.storyId === b.id).length - comments.filter((c) => c.storyId === a.id).length
    );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#0a0a0a] text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Nav, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 py-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap mb-8", children: cats.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          onClick: () => setCategory(c.id),
          className: `px-4 py-1.5 rounded-full text-sm font-medium border transition-all ${category === c.id ? "border-[#00fff7] text-[#00fff7] bg-[#00fff7]/10" : "border-[#333] text-gray-400 hover:border-[#555]"}`,
          children: c.label
        },
        c.id
      )) }),
      filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-center py-20", children: category === "favorites" ? "No favorites yet." : category === "similar" ? "Add favorites to see similar stories." : "No stories yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: filtered.map((story) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        StoryCard,
        {
          story,
          isFavorite: !!(myProfile == null ? void 0 : myProfile.favorites.includes(story.id)),
          commentCount: comments.filter((c) => c.storyId === story.id).length,
          onFavorite: () => toggleFavorite(story.id),
          onClick: () => {
...
function StoryCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "bg-[#111] border border-[#222] rounded-xl overflow-hidden hover:border-[#00fff7]/40 transition-all", children: [
    story.coverImage && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick,
    ...
    !story.coverImage && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        onClick,
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl opacity-20", children: "📖" })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
      ...
      story.subtext && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs italic mb-1", children: story.subtext }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm mb-3 line-clamp-2", children: story.excerpt }),
...
function StoryPage({
  ...
  const [pmText, setPmText] = reactExports.useState("");
  const [showPm, setShowPm] = reactExports.useState(false);
  const [pmSent, setPmSent] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 py-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold mb-2 text-white", children: story.title }),
    story.subtext && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm italic mb-3", children: story.subtext }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mb-6 flex-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prose max-w-none bg-white text-black leading-relaxed whitespace-pre-wrap mb-6 rounded-xl p-6 shadow", children: story.body }),
    story.images.map((img, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: img,
        alt: "",
    ...
    story.links.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-gray-400 mb-2", children: "Links" }),
      story.links.map((l, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          href: l.url,
          target: "_blank",
        ...
        `link-${i}-${l.url.slice(-8)}`
      ))
    ] }),
    story.googleDriveUrl && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        ...
        children: "📄 View on Google Drive"
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-[#222] pt-6 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: "✉ Send Private Review"
        }
      ),
      showPm && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: pmSent ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#39ff14] text-sm", children: "Message sent! Only the author can see it." }) : !principal ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm mb-2", children: "Please login to send a private message." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-[#222] pt-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-4", children: "Reviews & Comments" }),
      storyComments.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500", children: new Date(c.createdAt).toLocaleDateString() })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 text-sm", children: c.text })
          ]
        },
        c.id
      )),
      storyComments.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm", children: "No reviews yet. Be the first!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: !principal ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm mb-2", children: "Login to leave a review." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
      ...
      ] }) : isBanned ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-400 text-sm", children: "You are banned from leaving reviews." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            value: commentText,
...
function AboutPage({ authorBio }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold mb-6 text-white", children: "About the Author" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#111] border border-[#222] rounded-xl p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 leading-relaxed whitespace-pre-wrap", children: authorBio || "Author bio coming soon..." }) })
  ] });
}
function SeriesPage({
  stories,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 py-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold mb-8 text-white", children: "Story Series" }),
    series.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500", children: "No series yet." }),
    series.map((s) => {
      const seriesStories = stories.filter((st) => st.seriesId === s.id && st.published).sort((a, b) => (a.seriesOrder ?? 0) - (b.seriesOrder ?? 0));
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-[#00fff7] mb-2", children: s.title }),
        s.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm mb-3", children: s.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          seriesStories.map((st, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              onClick: () => {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-500 text-sm w-6", children: [
                  i + 1,
                  "."
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-sm", children: st.title })
              ]
            },
            st.id
          )),
          seriesStories.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm", children: "No stories in this series yet." })
        ] })
      ] }, s.id);
    })
  ] });
...
function ProfilePage({
  ...
  const isFollowing = (myProfile == null ? void 0 : myProfile.following.includes(principal)) ?? false;
  ...
  const historyStories = profile.readHistory.sort((a, b) => b.lastRead - a.lastRead).map((r) => ({ ...r, story: stories.find((s) => s.id === r.storyId) })).filter((r) => {
    var _a2;
    return (_a2 = r.story) == null ? void 0 : _a2.published;
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 py-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#111] border border-[#222] rounded-xl p-6 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-white mb-1", children: profile.displayName }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-500 text-xs mb-3", children: [
          principal.slice(0, 20),
          "..."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm", children: profile.bio || "No bio yet." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right text-sm text-gray-400", children: [
        ...
        !isMe && myPrincipal && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
    ...
    favoriteStories.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold mb-3 text-white", children: "Favorites" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: favoriteStories.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          onClick: () => {
    ...
    historyStories.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold mb-3 text-white", children: "Reading History" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: historyStories.map(
        (r) => r.story && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            onClick: () => {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-white", children: r.story.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 ml-2", children: new Date(r.lastRead).toLocaleDateString() })
            ]
          },
          r.storyId
        )
...
function AdminPage({
  ...
  const [tab, setTab] = reactExports.useState("stories");
  const [editStory, setEditStory] = reactExports.useState(null);
  const [editSeries, setEditSeries] = reactExports.useState(null);
  const [openPopupId, setOpenPopupId] = reactExports.useState(null);
  ...
  const [newCommentStoryId, setNewCommentStoryId] = reactExports.useState("");
  const [newCommentText, setNewCommentText] = reactExports.useState("");
  const [privateMessageTarget, setPrivateMessageTarget] = reactExports.useState(null);
  const [replyText, setReplyText] = reactExports.useState("");
  const [privateMessageText, setPrivateMessageText] = reactExports.useState("");
  const tabs = [
    "stories",
    "comments",
    "messages",
  ...
  function saveStory(publish) {
    if (!(editStory == null ? void 0 : editStory.title)) return;
    const publishedValue = publish !== void 0 ? publish : editStory.published ?? false;
    if (editStory.id) {
      setStories(
        (prev) => prev.map(
          (s) => s.id === editStory.id ? { ...s, ...editStory, published: publishedValue } : s
        )
      );
    } else {
      const newStory = {
  ...
  function togglePublished(id) {
    setStories(
      (prev) => prev.map((s) => s.id === id ? { ...s, published: !s.published } : s)
    );
  }
  function saveSeries() {
    if (!(editSeries == null ? void 0 : editSeries.title)) return;
    if (editSeries.id) {
      setSeries(
        (prev) => prev.map(
          (s) => s.id === editSeries.id ? { ...s, ...editSeries } : s
        )
      );
    } else {
      setSeries((prev) => [
  ...
  function addLink() {
    setEditStory((prev) => ({
      ...prev,
      links: [...(prev == null ? void 0 : prev.links) ?? [], { label: "", url: "" }]
    }));
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      role: "presentation",
      children: [
        privateMessageTarget && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-semibold mb-1", children: "Message Privately" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-400 text-sm mb-3", children: [
                    "To:",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#00fff7]", children: privateMessageTarget.author })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "textarea",
                    {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                children: siteOpen ? "Site is Open" : "Site is Closed"
              }
            ),
            siteOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap mb-6", children: tabs.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => setTab(t),
            className: `px-4 py-1.5 rounded-full text-sm capitalize border transition-all ${tab === t ? "border-[#00fff7] text-[#00fff7] bg-[#00fff7]/10" : "border-[#333] text-gray-400 hover:border-[#555]"}`,
            children: t
          },
          t
        )) }),
        tab === "stories" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => setEditStory({ links: [], images: [], published: false }),
              className: "mb-4 px-4 py-2 bg-[#00fff7] text-black rounded font-semibold text-sm hover:opacity-80",
              children: "Add Story"
            }
          ),
          editStory !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#111] border border-[#222] rounded-xl p-6 mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold mb-4 text-white", children: editStory.id ? "Edit Story" : "New Story" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  ...
                  onChange: (e) => setEditStory((p) => ({ ...p, subtext: e.target.value })),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  ...
                  onChange: (e) => setEditStory((p) => ({ ...p, excerpt: e.target.value })),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "textarea",
                {
                  ...
                  onChange: (e) => setEditStory((p) => ({ ...p, body: e.target.value })),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  ...
                  onChange: (e) => setEditStory((p) => ({ ...p, coverImage: e.target.value })),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "select",
                {
                  ...
                  onChange: (e) => setEditStory((p) => ({
                    ...p,
                    seriesId: e.target.value || void 0
                  })),
                  className: "w-full bg-[#1a1a1a] border border-[#333] rounded px-3 py-2 text-white text-sm focus:outline-none focus:border-[#00fff7]",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "No series" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-400", children: "Links" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                ...
                (editStory.links ?? []).map((l, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          ...
                          onChange: (e) => setEditStory((p) => ({
                            ...p,
                            links: ((p == null ? void 0 : p.links) ?? []).map(
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          ...
                          onChange: (e) => setEditStory((p) => ({
                            ...p,
                            links: ((p == null ? void 0 : p.links) ?? []).map(
                              (x, j) => j === i ? { ...x, url: e.target.value } : x
                            )
                          })),
                          placeholder: "URL",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ...
                        {
                          type: "button",
                          onClick: () => setEditStory((p) => ({
                            ...p,
                            links: ((p == null ? void 0 : p.links) ?? []).filter((_, j) => j !== i)
                          })),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: stories.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "bg-[#111] border border-[#222] rounded-lg px-4 py-3 flex items-center justify-between",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-white text-sm", children: s.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      children: s.published ? "✓ Published" : "✎ Draft"
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: s.published ? "Unpublish" : "Publish"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    {
                      type: "button",
                      onClick: () => setStories((prev) => prev.filter((x) => x.id !== s.id)),
        ...
        tab === "comments" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: "px-4 py-2 bg-[#00fff7] text-black rounded font-semibold text-sm hover:opacity-80",
              children: showAddComment ? "Cancel" : "Add Comment"
            }
          ) }),
          showAddComment && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#111] border border-[#222] rounded-xl p-5 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-white", children: "Add Admin Comment" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Select a story…" }),
                  stories.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: s.id, children: s.title }, s.id))
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          comments.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500", children: "No reviews yet." }),
          comments.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative inline-block", children: [
                    ...
                    c.featured && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-xs bg-yellow-500/20 text-yellow-400 border border-yellow-500/30 px-1.5 py-0.5 rounded", children: "Featured" }),
                    openPopupId === c.id && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "button",
                            {
                              ...
                              onClick: () => {
                                setComments(
                                  (prev) => prev.map(
                                    (x) => x.id === c.id ? { ...x, featured: !x.featured } : x
                                  )
                                );
                                setOpenPopupId(null);
                              },
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 ml-2", children: new Date(c.createdAt).toLocaleDateString() }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 text-sm mt-1", children: c.text }),
                  (replyTarget == null ? void 0 : replyTarget.commentId) === c.id && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 ml-4 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
        ...
        tab === "messages" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          privateMessages.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500", children: "No private messages yet." }),
          privateMessages.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative inline-block", children: [
                    ...
                    openPopupId === m.id && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: "absolute left-0 top-6 z-50 w-48 bg-[#1a1a1a] border border-[#333] rounded-lg shadow-xl overflow-hidden",
                        onClick: (e) => e.stopPropagation(),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 ml-2", children: new Date(m.createdAt).toLocaleDateString() }),
                  !m.read && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-xs text-[#00fff7]", children: "New" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 text-sm mt-1", children: m.text })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => setPrivateMessages(
                      (prev) => prev.map(
                        (x) => x.id === m.id ? { ...x, read: true } : x
                      )
                    ),
        ...
        tab === "series" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          editSeries !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#111] border border-[#222] rounded-xl p-6 mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold mb-4 text-white", children: editSeries.id ? "Edit Series" : "New Series" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  value: editSeries.title ?? "",
                  onChange: (e) => setEditSeries((p) => ({ ...p, title: e.target.value })),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: series.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "bg-[#111] border border-[#222] rounded-lg px-4 py-3 flex items-center justify-between",
              children: [
        ...
        tab === "banned" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          bannedUsers.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500", children: "No banned users." }),
          bannedUsers.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "bg-[#111] border border-[#222] rounded-lg px-4 py-3 flex items-center justify-between",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 ml-2", children: new Date(b.bannedAt).toLocaleDateString() })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
        ...
        tab === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-white mb-3", children: "Author Bio" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
              value: authorBio,
