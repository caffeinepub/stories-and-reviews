...
function App() {
  ...
  if (!siteOpen && !isAdmin) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center text-white", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mt-2", children: "This site is currently closed. Check back soon!" }),
      !principal && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          onClick: login,
          className: "mt-6 px-4 py-2 rounded bg-[#00fff7] text-black font-semibold text-sm hover:opacity-80",
...
function StoryPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 py-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prose prose-invert max-w-none text-gray-200 leading-relaxed whitespace-pre-wrap mb-6", children: story.body }),
