...
function AdminPage({
  ...
  function saveStory() {
    ...
    if (editStory.id) {
      setStories(
        (prev) => prev.map(
          (s) => s.id === editStory.id ? { ...s, ...editStory } : s
        )
      );
    } else {
      const newStory = {
        ...
        tab === "stories" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          editStory !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#111] border border-[#222] rounded-xl p-6 mb-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 text-sm text-gray-400 cursor-pointer", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "checkbox",
